...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'books_course', (
            ...
            ('semester', self.gf('django.db.models.fields.CharField')(default='spring', max_length=10)),
        ))
    ...
    models = {
        ...
        u'books.course': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'semester': ('django.db.models.fields.CharField', [], {'default': "'spring'", 'max_length': '10'}),
