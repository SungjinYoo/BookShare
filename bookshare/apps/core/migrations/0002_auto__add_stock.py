...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_stock', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default=u'available', max_length=10)),
        ))
        db.send_create_signal(u'core', ['Stock'])


    def backwards(self, orm):
        # Deleting model 'Stock'
        db.delete_table(u'core_stock')
    ...
    models = {
        ...
        u'core.stock': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "u'available'", 'max_length': '10'})
        }
    }
